...
# Modified instruct llama based on Stanford Alpaca: An Instruction-following LLaMA Model 
...
- [ ]  integrate lora training
 
- [ ]  test 7B lora training and evaluate
 
- [ ]  test 13B lora training and evaluate
